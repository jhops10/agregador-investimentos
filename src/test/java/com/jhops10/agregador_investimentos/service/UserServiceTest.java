...
class UserServiceTest {
    ...
    class createUser {
        ...
        void shouldCreateAUserWithSuccess() {
            ...
            var input = new CreateUserDto("user",
                    "email@email.com",
                    "123"
            );
    ...
    class updateUserById {
        ...
        @Test
        @DisplayName("Should update user by id with success when user exists and username and password is filled")
        void shouldUpdateUserByIdWithSuccessWhenUserExistsAndUsernameAndPasswordIsFilled() {
